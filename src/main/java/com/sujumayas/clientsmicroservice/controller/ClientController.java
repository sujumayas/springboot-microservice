...
public class ClientController {
    ...
    public void createClient(
            @ApiParam(value = "Client object you want to add. Please do not add an ID, it will be autogenerated by the database.", required = true) @RequestBody Client client){
    ...
    public void updateClient(
            @ApiParam(value = "Client object with properties you want to update", required = true) @RequestBody Client client, 
